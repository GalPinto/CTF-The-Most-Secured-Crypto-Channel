data_sent = open("../Downloads/sputnik/transmission1.txt").read()
bases_measured = open("../Downloads/sputnik/transmission2.txt").read()
bases_correct = open("../Downloads/sputnik/transmission3.txt").read()
...
# 1st option -> hex to ascii -> b64: ... -> to ascii -> Flag{Qu4n7umCryp70gr4phyIs4Fu7ur3}